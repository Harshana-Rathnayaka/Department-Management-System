                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <input required type="password" name="currentPassword" class="form-control" id="currentPasswordInput"
                                            placeholder="Enter your current password">
                                        <span class="mt-2 d-block">This is your current password.</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="newPasswordInput">New Password</label>
                                        <input required type="password" name="newPassword" class="form-control" id="newPasswordInput"
                                            placeholder="Enter the new password">
                                        <span class="mt-2 d-block">This is your new password.</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="confirmPasswordInput">Confirm New Password</label>
                                        <input required type="password" name="confirmNewPassword" class="form-control" id="confirmPasswordInput"
                                            placeholder="Confirm the new password">
                                        <span class="mt-2 d-block">This is your new password.</span>
                                    </div>
                                    <div class="form-footer pt-4 pt-5 mt-4 border-top">
                                        <button type="submit" name="changePasswordBtn" class="btn btn-primary btn-default">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
